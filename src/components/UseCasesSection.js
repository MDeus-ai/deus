...
// --- NEW: Helper component for the section banner ---
...
// Reusable Card Component (No changes needed here, it's perfect)
const UseCaseCard = ({ title, description }) => (
  <a 
    href="#" 
    className="group block bg-white border-2 border-black p-8 h-full flex flex-col justify-between 
...
export default function UseCasesSection() {
  ...
  return (
    // UPDATED: Section reskinned with yellow palette
    <section className="bg-yellow-400 text-black font-sans">
      ...
      <div className="container mx-auto px-4 py-20 lg:py-28">
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          {/* UPDATED: Text color for better contrast on yellow */}
          <p className="mt-4 text-lg text-black">
            Explore my activities in the datascience space.
          </p>
        </div>

        {/* Tab Navigation (No style changes needed) */}
