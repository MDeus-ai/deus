    ...
    <footer className="bg-background text-text-primary pb-2 pt-12 px-8 font-roboto-slab relative border-t border-gray-700">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-accent text-xl md:text-2xl font-semibold mb-4 relative pb-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-10 after:h-0.5 after:bg-accent">My Philosophy</h3>
          <div className="relative bg-accent-light p-6 rounded-lg shadow-md">
            ...
            <p className="text-text-primary text-base md:text-lg italic font-light leading-relaxed my-6">
              &quot;If it works, don&apos;t touch it&quot;
            </p>
            <FaQuoteRight className="text-accent text-xl md:text-2xl absolute -bottom-3 -right-3 opacity-70" />
          </div>
          <p className="text-text-secondary text-sm md:text-base leading-6 md:leading-7 font-light mt-4">
            This principle guides my approach to machine learning, emphasizing stability and reliability in my projects.
          </p>
        </div>

        <div className="flex flex-col gap-6">
          <h3 className="text-accent text-xl md:text-2xl font-semibold mb-4 relative pb-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-10 after:h-0.5 after:bg-accent">Get in Touch</h3>
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-accent text-xl md:text-2xl font-semibold mb-4 relative pb-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-10 after:h-0.5 after:bg-accent">Connect With Me</h3>
          <p className="text-text-secondary text-sm md:text-base leading-6 md:leading-7 font-light mb-4">
      ...
      <div className="text-center text-text-tertiary text-[10px] md:text-xs font-light mt-12">
